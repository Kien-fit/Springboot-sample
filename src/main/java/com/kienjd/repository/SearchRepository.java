...
import com.kienjd.repository.specification.SpecSearchCriteria;
...
import com.kienjd.repository.criteria.SearchCriteria;
import com.kienjd.repository.criteria.UserSearchQueryCriteriaConsumer;
...
import static com.kienjd.util.AppConst.*;
...
public class SearchRepository {
    ...
    public PageResponse<?> searchUser(int pageNo, int pageSize, String search, String sortBy) {
        ...
        StringBuilder sqlQuery = new StringBuilder("SELECT new com.kienjd.dto.response.UserDetailResponse(u.id, u.firstName, u.lastName, u.phone, u.email) FROM User u WHERE 1=1");
